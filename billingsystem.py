...
veghydrabadi=StringVar()
paneer=StringVar()
frenchFries=StringVar()
biryani=StringVar()
costveghydrabadi=StringVar()
costpaneer=StringVar()
...
#=============================Functions==================
def tPrice():
    cBprice=int(costveghydrabadi.get())
    bBprice=int(costpaneer.get())
    fFprice=int(costfrenchFries.get())
    sDprice=int(costbiryani.get())

    cBno=int(veghydrabadi.get())
    bBno=int(paneer.get())
    fFno=int(frenchFries.get())
    sDno=int(biryani.get())
    tempVat=int(vat.get())
...
# --------------
lblCb=Label(f1aa,font=('arial',16,'bold'),text="Veg Hydrabadi", bd=16, justify='left')
lblCb.grid(row=1,column=0)
txtCb=Entry(f1aa,font=('arial',16,'bold'),textvariable=veghydrabadi, bd=10,insertwidth=2, justify='left')
txtCb.grid(row=1,column=1)
# --------------
lblBb=Label(f1aa,font=('arial',16,'bold'),text="Paneer", bd=16, justify='left')
lblBb.grid(row=2,column=0)
txtBb=Entry(f1aa,font=('arial',16,'bold'),textvariable=paneer, bd=10,insertwidth=2, justify='left')
...
# --------------
lblSd=Label(f1aa,font=('arial',16,'bold'),text="Biryani", bd=16, justify='left')
lblSd.grid(row=4,column=0)
txtSd=Entry(f1aa,font=('arial',16,'bold'),textvariable=biryani, bd=10,insertwidth=2, justify='left')
...
# --------------
lblCcb=Label(f1ab,font=('arial',16,'bold'),text="Price of veg hydrabadi", bd=16, justify='left')
lblCcb.grid(row=1,column=0)
txtCcb=Entry(f1ab,font=('arial',16,'bold'),textvariable=costveghydrabadi, bd=10,insertwidth=2, justify='left')
txtCcb.grid(row=1,column=1)
# --------------
lblCbb=Label(f1ab,font=('arial',16,'bold'),text="Price of paneer", bd=16, justify='left')
lblCbb.grid(row=2,column=0)
txtCbb=Entry(f1ab,font=('arial',16,'bold'),textvariable=costpaneer, bd=10,insertwidth=2, justify='left')
...
# --------------
lblCsd=Label(f1ab,font=('arial',16,'bold'),text="Price of Biryani", bd=16, justify='left')
lblCsd.grid(row=4,column=0)
txtCsd=Entry(f1ab,font=('arial',16,'bold'),textvariable=costbiryani, bd=10,insertwidth=2, justify='left')
